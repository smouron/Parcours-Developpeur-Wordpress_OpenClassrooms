    ...
    public function checkCompatibility()
    {
        ...
        if (is_admin() || is_network_admin()) {
            ...
            try {
                ...
                //Compatibility with XMl Sitemap - tested 03032023
	    ...
	    if(HMWP_Classes_Tools::isPluginActive('woocommerce/woocommerce.php')){
			...
			//if Brute force is activated and woocommerce support is activated
		    if(HMWP_Classes_Tools::getOption('hmwp_bruteforce') && HMWP_Classes_Tools::getOption('hmwp_bruteforce_woocommerce')){
			    ...
			    if (HMWP_Classes_Tools::getOption('brute_use_math')) { //math recaptcha
				    ...
				    add_filter('woocommerce_login_form', array(HMWP_Classes_ObjController::getClass('HMWP_Models_Brute'), 'brute_recaptcha_head'), 99);
				    add_filter('woocommerce_login_form', array(HMWP_Classes_ObjController::getClass('HMWP_Models_Brute'), 'woocommerce_brute_recaptcha_form'), 99);

				    if(HMWP_Classes_Tools::getOption('hmwp_bruteforce_register')) {
					    add_filter('woocommerce_register_form', array(HMWP_Classes_ObjController::getClass('HMWP_Models_Brute'), 'brute_recaptcha_head'), 99);
					    add_filter('woocommerce_register_form', array(HMWP_Classes_ObjController::getClass('HMWP_Models_Brute'), 'woocommerce_brute_recaptcha_form'), 99);
				    }

				    if(HMWP_Classes_Tools::getOption('hmwp_bruteforce_lostpassword')) {
					    add_filter('woocommerce_lostpassword_form', array(HMWP_Classes_ObjController::getClass('HMWP_Models_Brute'), 'brute_recaptcha_head'), 99);
					    add_filter('woocommerce_lostpassword_form', array(HMWP_Classes_ObjController::getClass('HMWP_Models_Brute'), 'woocommerce_brute_recaptcha_form'), 99);
				    }

			    }elseif (HMWP_Classes_Tools::getOption('brute_use_captcha_v3')) { //recaptcha v3

				    add_filter('woocommerce_login_form', array(HMWP_Classes_ObjController::getClass('HMWP_Models_Brute'), 'brute_recaptcha_head_v3'), 99);
				    add_filter('woocommerce_login_form', array(HMWP_Classes_ObjController::getClass('HMWP_Models_Brute'), 'woocommerce_brute_recaptcha_form_v3'), 99);

				    if(HMWP_Classes_Tools::getOption('hmwp_bruteforce_lostpassword')) {
					    add_filter('woocommerce_lostpassword_form', array(HMWP_Classes_ObjController::getClass('HMWP_Models_Brute'), 'brute_recaptcha_head_v3'), 99);
					    add_filter('woocommerce_lostpassword_form', array(HMWP_Classes_ObjController::getClass('HMWP_Models_Brute'), 'woocommerce_brute_recaptcha_form_v3'), 99);
				    }
			    }
	    ...
	    //Compatibility with Memberpress and avoid hiding its login path
		if(HMWP_Classes_Tools::isPluginActive('memberpress/memberpress.php')){
			add_filter('hmwp_option_hmwp_hide_login', '__return_false');

			if(!HMWP_Classes_Tools::isPluginActive('memberpress-math-captcha/main.php')){
