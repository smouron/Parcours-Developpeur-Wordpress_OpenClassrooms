...
class HMWP_Controllers_Settings extends HMWP_Classes_FrontController
{
	...
	/**
     * Apply the settings, clear the cache, set the cookie for the current path
     *
	 * @return bool
	 * @throws Exception
	 */
	private function applyPermalinksChanged(){
        ...
        //clear the current redirect and rebuild them
	    ...
	    HMWP_Classes_ObjController::getClass('HMWP_Models_Compatibility_WpRocket')->rocket_burst_mapping();
